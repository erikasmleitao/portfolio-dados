...
### 👥 Visão Cliente
![Visão Cliente](dashboard-visao-cliente.png)

### 🛒 Comportamento de Compra
![Comportamento de Compra](dashboard-comportamento-compra.png)

### 📢 Performance das Campanhas
![Performance das Campanhas](dashboard-performance-campanhas.png)

### 🌍 Pontos de Venda
![Pontos de Venda](dashboard-pontos-venda.png)
